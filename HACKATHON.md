...
**Event page:** https://next-byte-hacks-v4.devpost.com/  ·  **Rules:** https://next-byte-hacks-v4.devpost.com/rules
**Deadline:** **Wed Sep 30, 2026 · 11:45 PM EDT**  (`2026-09-30T23:45:00-04:00`)
...
## Theme
“Build bold, ship fast”: working software built from scratch (web apps, games, hardware hacks).

## Prizes
- 1st $50
- 2nd $25
- 3rd $25
- Digital certificate for every submitter

## Submission requirements (from the event page)
- Devpost submission with description and technologies used
- Public code repository link
- A short demo video or screenshots, strongly encouraged

## Judging criteria

| Criterion | Weight |
|---|---|
| Creativity | unpublished (treat as equal unless the rules say otherwise) |
| Technical Execution | unpublished (treat as equal unless the rules say otherwise) |
| Design & User Experience | unpublished (treat as equal unless the rules say otherwise) |
| Impact | unpublished (treat as equal unless the rules say otherwise) |

## Event-specific deliverables (on top of CLAUDE.md's Definition of done)
- `submission/video/demo.mp4`: 1:30–2:30

## Strategy notes (starting hypotheses, which the research may overturn)
- Small field, student judges: boldness and a memorable wow moment beat everything else.
- A game or playful creative tool with a genuine real-impact angle is squarely on-brief.

**Suggested lane:** Bold or playful: a game, creative tool or interactive experience with real impact.
...
| [`next-byte-hacks-v4`](https://github.com/rishikrrontala-bot/next-byte-hacks-v4) | Next Byte Hacks V4 **← this repo** | Wed Sep 30, 2026 · 11:45 PM EDT | Bold or playful: a game, creative tool or interactive experience with real impact. |
